...
ckpt0_path = download(model_repo='RenRuiZhang/LLaMa-consolidated', model_name='consolidated.00_part0.pth')
ckpt1_path = download(model_repo='RenRuiZhang/LLaMa-consolidated', model_name='consolidated.00_part1.pth')
